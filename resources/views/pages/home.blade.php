...
@section('content')
        ...
        <div class="row align-items-center no-gutters align-items-stretch overlap-section">
            <div class="col-md-4">
                <div class="feature-1 pricing h-100 text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis ipsum odio minima
                        tempora
                        animi iure.</p>
                </div>
            </div>
    ...
    <div class="site-section block-13">
        ...
        <div class="owl-carousel nonloop-block-13">
            ...
            <div>
                <a href="#" class="unit-1 text-center">
                    <img src="{{ asset('asset/images/img_4.jpg') }}" alt="Image" class="img-fluid">
                    <div class="unit-1-text">
            ...
            <div>
                <a href="#" class="unit-1 text-center">
                    <img src="{{ asset('asset/images/img_5.jpg') }}" alt="Image" class="img-fluid">
                    <div class="unit-1-text">
    ...
    <div class="site-blocks-cover overlay inner-page-cover"
        style="background-image: url({{ asset('asset/images/hero_bg_2.jpg') }}); background-attachment: fixed;">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="slide-one-item home-slider owl-carousel">
                <div>
                    <div class="testimonial">
                        <figure class="mb-4">
                            <img src="{{ asset('asset/images/person_3.jpg') }}" alt="Image" class="img-fluid mb-3">
                            <p>John Smith</p>
                        </figure>
                        <blockquote>
                ...
                <div>
                    <div class="testimonial">
                        <figure class="mb-4">
                            <img src="{{ asset('asset/images/person_2.jpg') }}" alt="Image" class="img-fluid mb-3">
                ...
                <div>
                    <div class="testimonial">
                        <figure class="mb-4">
                            <img src="{{ asset('asset/images/person_4.jpg') }}" alt="Image" class="img-fluid mb-3">
                            <p>Robert Spears</p>
                        </figure>
                        <blockquote>
                            <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde
                ...
                <div>
                    <div class="testimonial">
                        <figure class="mb-4">
                            <img src="{{ asset('asset/images/person_5.jpg') }}" alt="Image" class="img-fluid mb-3">
                            <p>Bruce Rogers</p>
                        </figure>
                        <blockquote>
                            <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde
        ...
        <div class="container">
            ...
            <div class="row mb-3 align-items-stretch">
                <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
                    <div class="h-entry">
                        <img src="{{ asset('asset/images/blog_1.jpg') }}" alt="Image" class="img-fluid">
                ...
                <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
                    <div class="h-entry">
                        <img src="{{ asset('asset/images/blog_2.jpg') }}" alt="Image" class="img-fluid">
                        <h2 class="font-size-regular"><a href="#">Warehousing Your Packages</a></h2>
                        <div class="meta mb-4">by Theresa Winston <span class="mx-2">&bullet;</span> Jan 18, 2019 at
                            2:00 pm <span class="mx-2">&bullet;</span> <a href="#">News</a></div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eligendi nobis ea maiores
